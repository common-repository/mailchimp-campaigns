...
function mcWPfeed(){
	...
	*/
	...
	$open = simplexml_load_file($feed) or die("<div class=\"error\">Couldn't access your feed at ".$feed.". Please check to make sure your feed is public.  If it is publicly accessible, make sure the feed also <a href=\"http://validator.w3.org/feed\">validates</a>.</div>");
	?>
	<h1>Feed Content</h1>
