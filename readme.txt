...
== Changelog ==
= 1.03 =
* Clearer error messaging when a feed can't be pulled.
* Added a signup form to get notifications when the plugin is out of beta (and finally looks nice).
* Changed "MailChimp Curator" tab name to "MailChimp Campaigns" to avoid confusion.

= 1.02 =
* Changed the way that the feed was pulled to hopefully alleviate any issues.
* Now using WordPress function get_bloginfo_rss('rss2_url').
